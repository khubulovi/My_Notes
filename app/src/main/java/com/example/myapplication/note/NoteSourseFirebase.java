...
public class NoteSourseFirebase implements NoteSourceInteface {
    ...
    @Override
    public NoteSourceInteface init(final NoteSourceResponce notesSourceResponse) {
        collection.orderBy(NoteMapping.Fields.DATE, Query.Direction.DESCENDING).get()
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        notesSourceResponse.initialized(NoteSourseFirebase.this);
                    } else {
